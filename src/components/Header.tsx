...
export default function Header() {
  return (
    <header className="flex flex-row bg-transparent h-16 fixed z-10 w-full">
        <nav className="flex items-center justify-between text-white container mx-auto px-10">
